...
export default function Home() {
  ...
  return (
    ...
    >
        ...
        {!isMobile && (
          <motion.div
            ...
            style={{
              ...
              // top: -44px → dog spans -44px to 20px. Only 20px on nav bar,
              // 44px above. Sits on the edge, most of body above the nav.
              top: '-44px',
              left: '30px',
              zIndex: 55,
              width: '64px',
      ...
      {/* ============ FOOTER ============ */}
      <footer className="relative z-10 border-t border-amber-900/30 py-8 px-6" style={{ background: '#1a1010' }}>
