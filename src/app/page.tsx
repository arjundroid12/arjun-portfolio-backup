...
const AI_AGENTS = [
  {
    ...
    demo: 'https://ai-research-agent.vercel.app',
  ...
  },
  {
    ...
    demo: 'https://multi-agent-system-arjundroid12s-projects.vercel.app',
    difficulty: 'Advanced',
  },
  {
    ...
    demo: 'https://data-analyst-agent-arjundroid12s-projects.vercel.app',
    difficulty: 'Advanced',
  },
  {
    name: 'Coding Agent',
    ...
    demo: 'https://coding-agent-arjundroid12s-projects.vercel.app',
    difficulty: 'Advanced',
  },
]
...
const PROJECTS = [
  ...
  { name: 'Calculator', desc: 'Calculator with custom expression parser and history', longDesc: 'Clean modern calculator with keyboard support, history panel, and dark mode. Uses a custom shunting-yard expression parser (no eval) for safe evaluation.', tech: ['Vanilla JS', 'HTML5', 'CSS3'], category: 'Frontend', icon: '🧮', rarity: 'common', repo: 'https://github.com/arjundroid12/calculator-app', demo: 'https://calculator-app-arjundroid12s-projects.vercel.app', features: ['Custom expression parser', 'Calculation history', 'Keyboard support', 'Dark/light theme'] },
